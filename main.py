...
class BookCollection:
    ...
    def create_new_book(self):
        ...
        # Creating a new book dictionary
        new_book = {
            "title": book_title,
            "author": book_author,
    ...
    def find_book(self):
        ...
        # List of books that match the search term
        found_books = [
        ...
        if found_books:
            ...
            for index, book in enumerate(found_books, 1):
                ...
                print(
                    ...
                    f"({book['year']}) - {book['genre']} - {reading_status}"
                )
        else:
    ...
    def update_book(self):
        ...
        for book in self.book_list:
            if book["title"].lower() == book_title.lower():
                ...
                # Update fields, keep existing values if left blank
